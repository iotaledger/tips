...
[Chrysalis Part 2 Transaction Payload RFC.](https://github.com/iotaledger/protocol-rfcs/pull/18)

The PR [iotaledger/protocol-rfcs#0040](https://github.com/iotaledger/protocol-rfcs/pull/40) updates the aforementioned
RFC with the new transaction layout and validation rules. The updated version is the basis for
output validation in this RFC.
