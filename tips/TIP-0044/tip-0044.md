...
author: Philipp Gackstatter (@PhilippGackstatter) <philipp.gackstatter@iota.org>, Levente Pap (@lzpap) <levente.pap@iota.org>, Roman Overko (@roman1e2f5p8s) <roman.overko@iota.org>
discussions-to: TODO
status: Draft
type: Standards
layer: Core
...
- Remove `Native Tokens` field and add `Native Token Feature` to allowed features. See [TIP-38 (Native Token Migration)](../TIP-0038/tip-0038.md#native-token-migration) for migration details.
