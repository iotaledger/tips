...
author: Adam (@AdamCroply) <adam@tanglelabs.io>, Merul (@coodos) <merul@tanglelabs.io>
...
- `creatorID` must be the original creatorID UTXO string
...
{
  "registration": {
    "creatorId": "s345d6f7g8h9ji07gy8h99",
