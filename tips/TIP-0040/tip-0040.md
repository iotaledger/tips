...
TODO: Do we have to state the following or can we just include it in the calculations? Since the `Performance Factor` is
a uint8, a right-shift of 8 bits should be later applied to the sum.
