...
- TODO: Let `decay(n)` be the decay factor (?) defined in TIP-39.
...
- TODO: When do rewards become available exactly? -> With the slot committment of the last slot of an epoch.
