...
This document defines the NFT output type and transaction validation rules for the IOTA protocol to support Layer 1 native **non-fungible tokens** (unique tokens with attached metadata). It was originally introduced in [TIP-18](../TIP-0018/tip-0018.md) and the functionality defined in this document is a strict extension of the NFT output of TIP-18.
