      ...
      <details open="true">
        ...
        <table>
            ...
            <tr>
                ...
                <td>uint8</td>
                <td>
                VByte Factor Key defines the factor to be used for data only fields.
                </td>
            </tr>
            <tr>
                <td>VByte Factor Key</td>
            ...
            <tr>
                <td>VByte Factor Issuer Keys</td>
                <td>uint8</td>
                <td>
                VByte Factor Issuer Keys defines the factor to be used for block issuer feature public keys.
                </td>
            </tr>
            <tr>
