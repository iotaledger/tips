...
![](assets/deposit_iota_AliasOutput_(min_functionality).jpg)

![](assets/deposit_iota_AliasOutput_(max_functionality).jpg)
...
![](assets/deposit_iota_FoundryOutput_(min_functionality).jpg)

![](assets/deposit_iota_FoundryOutput_(max_functionality).jpg)
