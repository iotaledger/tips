...
- The following condition must hold: `Block Issuer Key Count <= 128`.
- The following condition must hold: Each key in `Block Issuer Keys` must be unique based on its `Public Key`. No
