...
- When a _Staking Feature_ is present in an account output on the output side of a transaction, the transaction that
  ...
  - If the Staking Feature was not present on the account input, all of the following conditions must hold:
    ...
    - `End Epoch` satisfies `End Epoch >= Transaction Epoch Index + Staking Unbonding Period`.
    ...
    - One of the following conditions must hold:
      ...
      - All of the following conditions hold:
        ...
        - The Mana amount on the input side of the transaction is increased by at most the amount defined in
          [TIP-40 (Validator Rewards)](../TIP-0040/tip-0040.md#validator-rewards).
    - The fields `Staked Amount`, `Start Epoch`, `End Epoch` and `Fixed Cost` on the feature on the input and the
      feature on the output side match.
...
- Governance transition:
  ...
  - Governance transition must only change the following fields:
    ...
    - `Metadata Feature`, `Sender Feature`, `Block Issuer Feature` and `Staking Feature` in `Features`.
...
<table>
    <details>
        ...
        <table>
            ...
            <tr>
                <td>TODO: Update: v_byte Minimum</td>
                <td>477</td>
            </tr>
            <tr>
                <td>TODO: Update: v_byte Maximum</td>
                <td>29641</td>
            </tr>
        </table>
    </details>
