...
- Mana Amount `mana_amount` field must be ≥ `0` and ≤ `TOTAL_MANA`.
...
![](assets/deposit_miota_AccountOutput_(min_functionality).jpg)

![](assets/deposit_miota_AccountOutput_(max_functionality).jpg)
