...
- When a _Staking Feature_ is present in an account output on the input side of a transaction, the transaction that
  ...
  - If `Transaction Epoch Index < End Epoch`, all of the following conditions must hold:
    ...
    - One of the following conditions hold:
      - `End Epoch` in the _Staking Feature_ on the output is equal to `End Epoch` in the _Staking Feature_ on the
        input.
      - `End Epoch` satisfies `End Epoch >= Transaction Epoch Index + Staking Unbonding Period`.
  - If `Transaction Epoch Index >= End Epoch`, either of the following conditions must hold:
