...
- It is possible to intentionally deadlock accounts and NFTs, however client side software can notify users when they
  perform such action. Deadlocked accounts and NFTs can not be unlocked, but this is true for any funds locked into
...
- Accounts can be destroyed even if there are foundries alive that they control. Since only the controlling account can
