...
Data types and subschemas used throughout this RFC are defined in [draft TIP-21](https://github.com/iotaledger/protocol-rfcs/pull/41).
...
[Draft TIP-20](https://github.com/iotaledger/protocol-rfcs/pull/40) replaces the aforementioned
...
is deprecated with the replacement of the [draft TIP-20 Transaction Payload](https://github.com/iotaledger/protocol-rfcs/pull/40).
