...
Additional constraints are defined in the [Anchor Output](#anchor-output) section.
...
The additional constraints are defined in the [Anchor Output](#anchor-output) section.
...
<table>
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <details>
        <summary>State Metadata Feature</summary>
        <blockquote>Defines a map of key-value pairs that is stored in the output, that can only be modified by the State Controller. Defined in <a href='../TIP-0054/tip-0054.md#state-metadata-feature'>TIP-54 (State Metadata Feature)</a>.</blockquote>
        <table>
          <tr>
            <td>
              <b>Name</b>
...
- State transition:
  ...
  - State transition can only change the following fields in the next state:
    ...
    - `Mana`,
    - `State Index`,
    - `State Metadata Feature` in `Features`.
