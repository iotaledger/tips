...
The schema of a _Basic Block_ is that of a _Block Wrapper_ with the _Block_ field containing the following schema:
...
The schema of a _Validation Block_ is that of a _Block Wrapper_ with the _Block_ field containing the following schema:
