...
right-shift_ or _logical shift_ operation. Epochs are counted starting from `1` with `0` being reserved for the genesis,
which has to be addressable as its own epoch.
