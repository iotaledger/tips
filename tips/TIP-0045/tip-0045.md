      ...
      <details open="true">
        ...
        <table>
          ...
          <tr>
            <td>Network ID</td>
            <td>uint64</td>
            <td>The ID of the network for which this transaction is valid for. It consists of the first 8 bytes of the BLAKE2b-256 hash of the <code>Network Name</code>.</td>
          </tr>
          <tr>
            <td>Creation Slot</td>
            <td>uint32</td>
